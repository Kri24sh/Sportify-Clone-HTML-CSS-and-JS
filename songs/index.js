...
let songs =
    [
        ...
        { song_name: "California Love", File_path: "songs/song2.mp3", cover_path: src = "pics/song2.png", cast_name: "Gur Sidhu , Cheema Y", time_update: "2:55" },
        ...
        { song_name: "Rao Sahab Drill", File_path: "songs/song4.mp3", cover_path: src = "pics/song4.png", cast_name: "Vkey, SDEE", time_update: "3:31" },
        { song_name: "Check It Out", File_path: "songs/song5.mp3", cover_path: src = "pics/song5.png", cast_name: "Parmish Verma, Paradox", time_update: "3:15" },
        { song_name: "Yadav Brand 2", File_path: "songs/song6.mp3", cover_path: src = "pics/song6.png", cast_name: "Sunny Yaduvanshi, AK RoK, Nitesh Ujoli ", time_update: "2:54" },
        { song_name: "Haryana Hood", File_path: "songs/song7.mp3", cover_path: src = "pics/song7.png", cast_name: "Irshad Khan", time_update: "3:31" },
        { song_name: "9:45 ", File_path: "songs/song8.mp3", cover_path: src = "pics/song8.png", cast_name: "Prabh Singh, Jay Trak", time_update: "1:57" },
    ];
...
Array.from(document.getElementsByClassName('songdata')).forEach((element, i) => {
    element.addEventListener('click', (e) => {
        ...
        play_pause_btn.classList.remove('fa-circle-play');
        play_pause_btn.classList.add('fa-circle-pause');
        audio_element.src = `songs/song${song_index}.mp3`;
...
// if((   vol_bar.value / 100) == 0)
// {
//     volicone.classList.remove('fa-volume-off');
//     volicone.classList.add('fa-volume-mute');
// }
// if((vol_bar.value/100) > 0 || vol_bar.value/100 < 0.5)
// {
//     volicone.classList.remove('fa-volume-mute');
//     volicone.classList.add('fa-volume-low');
// }

// if((vol_bar.value/100) > 0.5 ){
//     volicone.classList.remove('fa-volume-low');
//     volicone.classList.add('fa-volume-high');
// }
